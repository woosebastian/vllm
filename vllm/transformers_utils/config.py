...
def _uses_mrope(config: PretrainedConfig) -> bool:
    ...
    # Qwen3.5 text models (model_type="qwen3_5_text") store mrope_section and
    # mrope_interleaved in rope_parameters as part of their RoPE config, but do
    # not actually use M-RoPE positional encoding. The config explicitly lists
    # these keys in ignore_keys_at_rope_validation for the same reason.
